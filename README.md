...
- 등장 리듬은 **사람이 말하는 속도** : 단어 안에서는 글자가 24ms 간격으로 빠르게 번져 나오고(왼→오),
  다음 단어는 그 단어를 말하는 시간(글자 수 × 한국어 120ms / 영어 48ms + 70ms) 뒤에. 쉼표 +220ms, 문장 끝 +420ms,
  한국어 문구의 줄바꿈 +380ms (겹치면 긴 쪽만). 문장별 속도 rate : 영어 인사 1.3, 길안내 라벨 .7.
  실측 : '장소나@620 → 오늘의@1430', 'area.@1524 → Please@2254', 'Afternoon!@341 → Leo.@1602'.
