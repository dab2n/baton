...
- 인사 문구 교체는 제자리에서 : `inPlace`(들어올 때) / `out`(나갈 때) 모두 translate 없이 흐림+투명도만, `--i` 로 위→아래·왼→오른쪽 순서 (0.9s 동안 사라지고 6s 주기)
- 언어 전환은 connecting 8.2s : 한국어 지우기 3.0~6.0s, 영어 0.9s 뒤따라 3.9~6.9s, 아랫줄 +0.9s
